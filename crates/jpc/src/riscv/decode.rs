...
pub fn decode(code: u32, target: &Target) -> Instruction {
    ...
    match (opcode, funct3, funct7) {
        ...
        (Op::JALR, 0b000, _) => JALR {
            rd,
            rs1,
            offset: i_imm,
        },
        (Op::BRANCH, 0b000, _) => BEQ {
            rs1,
            rs2,
            offset: b_imm,
        },
        (Op::BRANCH, 0b001, _) => BNE {
            rs1,
            rs2,
            offset: b_imm,
        },
        (Op::BRANCH, 0b100, _) => BLT {
            rs1,
            rs2,
            offset: b_imm,
        },
        (Op::BRANCH, 0b101, _) => BGE {
            rs1,
            rs2,
            offset: b_imm,
        },
        (Op::BRANCH, 0b110, _) => BLTU {
            rs1,
            rs2,
            offset: b_imm,
        },
        (Op::BRANCH, 0b111, _) => BGEU {
            rs1,
            rs2,
            offset: b_imm,
        },
        ...
        (Op::OP_IMM, 0b000, _) => ADDI {
            rd,
            rs1,
            imm: i_imm,
        },
        (Op::OP_IMM, 0b010, _) => SLTI {
            rd,
            rs1,
            imm: i_imm,
        },
        (Op::OP_IMM, 0b011, _) => SLTIU {
            rd,
            rs1,
            imm: i_imm,
        },
        (Op::OP_IMM, 0b100, _) => XORI {
            rd,
            rs1,
            imm: i_imm,
        },
        (Op::OP_IMM, 0b110, _) => ORI {
            rd,
            rs1,
            imm: i_imm,
        },
        (Op::OP_IMM, 0b111, _) => ANDI {
            rd,
            rs1,
            imm: i_imm,
        },
        ...
        (Op::LOAD, 0b110, _) if rv64 => LWU {
            rd,
            rs1,
            offset: i_imm,
        },
        (Op::LOAD, 0b011, _) if rv64 => LD {
            rd,
            rs1,
            offset: i_imm,
        },
        (Op::STORE, 0b011, _) if rv64 => SD {
            rs1,
            rs2,
            offset: s_imm,
        },
        ...
        (Op::OP_IMM_32, 0b000, _) if rv64 => ADDIW {
            rd,
            rs1,
            imm: i_imm,
        },
        (Op::OP_IMM_32, 0b001, 0b0000000) if rv64 => SLLIW {
            rd,
            rs1,
            shamt: shamt32,
        },
        (Op::OP_IMM_32, 0b101, 0b0000000) if rv64 => SRLIW {
            rd,
            rs1,
            shamt: shamt32,
        },
        (Op::OP_IMM_32, 0b101, 0b0100000) if rv64 => SRAIW {
            rd,
            rs1,
            shamt: shamt32,
        },
        ...
        // F extension:
        (Op::LOAD_FP, 0b010, _) if ext_f => FLW {
            frd,
            rs1,
            offset: i_imm,
        },
        (Op::STORE_FP, 0b010, _) if ext_f => FSW {
            rs1,
            frs2,
            offset: s_imm,
        },
        (Op::MADD, _, f7) if ext_f && f7 & 0b11 == 0b00 => FMADD_S {
            frd,
            rm,
            frs1,
            frs2,
        ...
        (Op::MSUB, _, f7) if ext_f && f7 & 0b11 == 0b00 => FMSUB_S {
            frd,
            rm,
            frs1,
            frs2,
        ...
        (Op::NMSUB, _, f7) if ext_f && f7 & 0b11 == 0b00 => FNMSUB_S {
            frd,
            rm,
            frs1,
            frs2,
        ...
        (Op::NMADD, _, f7) if ext_f && f7 & 0b11 == 0b00 => FNMADD_S {
            frd,
            rm,
            frs1,
            frs2,
        ...
        (Op::OP_FP, _, 0b0000000) if ext_f => FADD_S {
            frd,
            rm,
            frs1,
            frs2,
        ...
        (Op::OP_FP, _, 0b0001100) if ext_f => FDIV_S {
            frd,
            rm,
            frs1,
            frs2,
        },
        (Op::OP_FP, _, 0b0000100) if ext_f => FSUB_S {
            frd,
            rm,
            frs1,
            frs2,
        },
        (Op::OP_FP, _, 0b0001000) if ext_f => FMUL_S {
            frd,
            rm,
            frs1,
            frs2,
